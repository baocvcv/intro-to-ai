...
public:
    ...
    bool is_won(int player) const {
        ...
        bits horWithi = BitSet::andWith(board, BitSet::andWith(BitSet::rightShift(board, 16), BitSet::andWith(BitSet::rightShift(board, 32), BitSet::rightShift(board, 48))));
        ...
        bits final = BitSet::orWith(horWithi, BitSet::orWith(vert, BitSet::orWith(bslash, slash)));
